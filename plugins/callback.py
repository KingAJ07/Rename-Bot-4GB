...
async def donatecm(bot,message):
    ...
    keybord = InlineKeyboardMarkup([
        [InlineKeyboardButton("🦋 Admin",url = "https://t.me/AJ_TVSERIAL_BOT"),
...
async def home_callback_handler(bot, query):
    ...
    keybord = InlineKeyboardMarkup([  
                    [InlineKeyboardButton("📢 𝖩𝗈ꪱᜒ𐓣 ᝪυ𝗋 Τ౿ᥣ౿𝗀𝗋ɑო 𝖢𝗁ɑ𐓣𐓣౿ᥣ", url="https://t.me/AJ_TVSERIAL"),
                    InlineKeyboardButton("💬 Support", url="https://t.me/AJ_TVSERIAL_BOT")],
                    [InlineKeyboardButton("🛠️ Help", callback_data='help'),
		            InlineKeyboardButton("❤️‍🩹 About", callback_data='about')],
                    [InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url="https://t.me/AJ_TVSERIAL_BOT")]
		  ])
